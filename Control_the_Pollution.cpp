...
{   
    ...
    int ans =  0 ;
    int bus = ceil( (double)n / (double)100) * x;
    int car = ceil( (double)n / (double)4) * y;
    
    int common = floor( (double)n / (double)100) * x  + ceil( (double)(n % 100)/ (double)4) * y;
    // cout << bus << " " << car << " " << common << endl;
    ans = min({bus , car , common});
    
    // while(true)
    // {
    //     int a = max((floor( (double)n / (double)100)),1.0) * x ;
    //     int b =max((floor( (double)n / (double)4)),1.0) * y ;
    //     if ( b == 0 )
    //     {
    //         b = 1* y ;
    //     }
    ...
    //     if( a <= b)
    //     {
    //         n = n -(max((floor( (double)n / (double)100)),1.0) * 100);
             
    //     }
    //     else
    //     {

    //        n = n -( max((floor( (double)n / (double)4)),1.0) * 4);
    //     }
    //     if( n < 0 )
    //     {
    //         break;
